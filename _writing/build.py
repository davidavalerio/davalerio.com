...
and the grouped list on the homepage (between the writing markers in
../index.html) is refreshed.
"""
import datetime
import email.utils
import html
...
<body>
    <header class="site">
        ...
        <nav>
            ...
            <button type="button" class="theme-toggle" aria-label="Switch between light and dark" hidden></button>
        </nav>
    </header>
"""
...
START = "<!-- writing:start (generated by _writing/build.py — do not edit by hand) -->"
END = "<!-- writing:end -->"
...
<head>
  ...
  <title>Writing — David Valerio</title>
</head>
<body>
  <p>The writing is on the <a href="/#writing">homepage</a>.</p>
</body>
</html>
""".format(SITE)


def homepage_list(posts):
    out = '    <section id="writing">\n        <h2>Writing</h2>\n        <nav class="kinds">'
...
def main():
    ...
    write(os.path.join(OUT, "index.html"), FORWARD)
